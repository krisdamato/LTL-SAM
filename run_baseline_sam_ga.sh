...
python -m scoop -n 96 bin/ltl-sam-nes.py -n SAM-0_1ms-NES-Pecevski -r 0.1 -fd 0.1 -p
python -m scoop -n 96 bin/ltl-sam-nes.py -n SAM-0_2ms-NES-Pecevski -r 0.1 -fd 0.2 -p
python -m scoop -n 96 bin/ltl-sam-nes.py -n SAM-0_5ms-NES-Pecevski -r 0.1 -fd 0.5 -p
python -m scoop -n 96 bin/ltl-sam-nes.py -n SAM-1_0ms-NES-Pecevski -r 0.1 -fd 1.0 -p
python -m scoop -n 96 bin/ltl-sam-nes.py -n SAM-2_0ms-NES-Pecevski -r 0.1 -fd 2.0 -p
